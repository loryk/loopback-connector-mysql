...
var db, UserData, ComlexData, StringData, NumberData, DateData, DefaultData, SimpleEmployee;
var mysqlVersion;
...
describe('migrations', function() {
  ...
  it('ComlexData should have both id,subid columns and id should be auto_increment', function(done) {
    getFields('ComlexData', function(err, fields) {
      if (!fields) return done();
      fields.should.be.eql({
        id: {
          Field: 'id',
...
function setup(done) {
  ...
  ComlexData = db.define('ComlexData', {
